<template>
  <div id="kt_aside" class="aside aside-extended" data-kt-drawer="true" data-kt-drawer-name="aside"
          ...
          <ul class="nav flex-column">
            ...
            <li class="nav-item mb-2" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="right"
              ...
              <a class="nav-link btn btn-custom btn-icon" data-bs-toggle="tab" href="#kt_aside_nav_tab_projects">
                ...
                <span class="svg-icon svg-icon-2x">
                          ...
                          <path d="M2266 8574 c-8 -60 -8 -7107 0 -7156 l7 -38 748 0 749 0 2 1298 3
                          1297 925 6 c914 6 991 9 1205 44 425 69 759 189 1036 371 118 78 349 299 412
                          396 50 76 147 248 147 260 0 6 13 38 29 72 87 183 160 482 181 743 6 70 15
                          169 20 220 13 119 13 375 0 477 -5 45 -17 144 -25 221 -20 187 -72 410 -135
                          582 -48 132 -154 330 -224 418 -17 22 -44 58 -59 81 -42 63 -201 213 -312 295
                          -87 65 -146 102 -270 171 -85 48 -197 96 -300 129 -33 11 -69 24 -80 29 -18 9
                          -133 41 -215 61 -98 23 -268 50 -370 59 -69 6 -779 10 -1791 10 l-1676 0 -7
                          -46z m3199 -1233 c133 -28 256 -75 400 -153 46 -25 215 -191 215 -212 0 -7 10
                          -28 23 -47 34 -51 84 -201 104 -314 28 -156 25 -483 -5 -630 -22 -104 -31
                          -134 -84 -257 -42 -96 -172 -247 -274 -316 -107 -72 -301 -142 -449 -162 -73
                          -9 -897 -15 -1597 -10 l-28 0 0 1059 0 1060 33 3 c17 2 385 1 817 -2 580 -4
                          801 -9 845 -19z"/>
                          </g>
                          </svg>
											</span>
            ...
            <li class="nav-item mb-2" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="right"
              ...
              <a class="nav-link btn btn-custom btn-icon" data-bs-toggle="tab" href="#kt_aside_nav_tab_authors">
                ...
                <span class="svg-icon svg-icon-2x">
											<svg version="1.0" xmlns="http://www.w3.org/2000/svg"
                           width="860.000000pt" height="900.000000pt" viewBox="0 0 860.000000 900.000000"
                           preserveAspectRatio="xMidYMid meet">
            ...
            <div class="tab-content">
              ...
              <div class="tab-pane fade" id="kt_topbar_notifications_1" role="tabpanel">
                ...
                <div class="py-3 text-center border-top">
                  <a href="../dist/pages/profile/activity.html" class="btn btn-color-gray-600 btn-active-color-primary">View
                    All
    ...
    <button
        ...
        data-kt-toggle-name="aside-minimize" style="margin-bottom: 1.35rem" id="hideButtonMin">
