    ...
    <div class="card">
          ...
          <div class="notice d-flex bg-light-primary rounded border-primary border border-dashed p-6">
            <div class="d-flex flex-stack flex-grow-1">
              <div class="fw-semibold">
                <div class="fs-6 text-gray-700">Na het opslaan van de administrator wordt er automatisch een email verstuurd naar het ingevulde adres. Via deze email krijgt de administrator de mogelijkheid om een wachtwoord in te stellen.</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="card-footer">
        <div class="d-flex flex-stack">
          <div class="mr-2">
            <router-link to="/admins" type="button" class="btn btn-lg btn-light-primary">
