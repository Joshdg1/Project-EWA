<template>
  <div>
    <div class="mb-5">
      ...
      <input type="text" class="form-control form-control-lg " v-model="formData.name" placeholder=""
             value="">
      <div v-if="errors.name" class="text-danger fs-7">{{ errors.name }}</div>
    </div>
    <div class="mb-5">
      <label class="form-label mb-3">Beschrijving</label>
      <textarea class="form-control form-control-lg " v-model="formData.description" placeholder=""
                value="">
            </textarea>
    ...
    <div class="mb-5">
      ...
      <select class="form-select form-select-lg " v-model="formData.client_id">
    ...
    <div class="mb-5">
      ...
      <input type="date" class="form-control form-control-lg " v-model="formData.start" placeholder=""
             value="">
      <div v-if="errors.start" class="text-danger fs-7">{{ errors.start }}</div>
    </div>
    <div class="mb-5">
      <label class="form-label mb-3">Deadline</label>
      <input type="date" class="form-control form-control-lg " v-model="formData.end" placeholder=""
             value="">
